 ...
 *   example-6.c
 *
 *   XML config file parser example 6 (is example-2 but with MD5 checksums)
 *
...
if (argc == 2) {
   ...
   freeConfigStructContent(config, &vNTL, QUIET);								// free the contents of the config structure
